...
function D3ChartTest() {
  ...
  useEffect(() => {
    ...
    //Read the data
    csv('https://raw.githubusercontent.com/holtzy/data_to_viz/master/Example_dataset/2_TwoNum.csv', (data): any => {
      ...
      // Add X axis
      const x = scaleLinear().domain([0, 4000]).range([0, width])
      svg
        .append('g')
      ...
      // Add Y axis
      const y = scaleLinear().domain([0, 500000]).range([height, 0])
