...
export const ChartDataSelection = (props: any) => {
  ...
  const droplist = [{ value: 'DragXY' }, { value: 'DragX' }, { value: 'DragY' }, { value: 'Lasso' }]
  function change() {
    chartInstance.selectionMode = dropElement.value
  ...
  return (
    ...
    //             <td style={{ width: '20%' }}>
    //               <div>
    //                 <input type="checkbox" id="select" onChange={check.bind(this)} ref={(d) => (checkElement = d)} />
    //               </div>
    //             </td>
    //           </tr>
    //         </table>
...
export default ChartDataSelection
