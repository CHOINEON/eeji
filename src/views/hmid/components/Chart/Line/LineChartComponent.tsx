          ...
          <DrawerBody>
            <Accordion allowToggle>
              ...
              <AccordionItem>
                ...
                <AccordionPanel pb={4}>
                  <div>Enable / Disable Marker</div>
                  <Switch
                    size="lg"
                    colorScheme="brand"
                    value={state.ENABLE_MARKER}
                    onChange={() => {
                      dispatch({ type: 'ENABLE_MARKER' })
                    }}
                  />
                </AccordionPanel>
              </AccordionItem>
              ...
              <AccordionItem>
                <h2>
                  <AccordionButton>
                    <Box as="span" flex="1" textAlign="left">
                      <MdOutlineFontDownload style={{ display: 'inline-block' }} />
                      <AccordionTitle>Text & Position</AccordionTitle>
                    </Box>
                    <AccordionIcon />
                  </AccordionButton>
                </h2>
